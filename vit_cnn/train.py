...
def train_and_validate(model, optimizer, train_loader, val_loader, device, checkpoint_path,save_info_path, epochs=5, save_model=True,scheduler=None,pretrain_ViT=False):
