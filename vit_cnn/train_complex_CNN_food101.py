...
if __name__=='__main__':
    ...
    model = ComplexCNN(num_classes=101, im_size=224).to(device)

    checkpoint_path="weights/food101_complexCNN"
    ...
    train_and_validate(model, config, food_trainloader, food_valoader, 101, device, epochs=20, im_size=224, checkpoint_path=checkpoint_path)